            ...
            modelBuilder.Entity("GymManagementDAL.Entities.Member", b =>
                {
                    ...
                    b.ToTable("Members", t =>
                        {
                            t.HasCheckConstraint("Gym_CheckEmail", "Email LIKE '_%@_%._%'");

                            t.HasCheckConstraint("Gym_CheckPhone", "Phone LIKE '01%' and Phone Not Like '%[^0-9]%'");
                        });
                });
            ...
            modelBuilder.Entity("GymManagementDAL.Entities.Plan", b =>
                {
                    ...
                    b.ToTable("Plans", t =>
                        {
                            t.HasCheckConstraint("Plan_CheckDuration", "DurationDays Between 1 and 365");
                        });
                });
                    ...
                    b.ToTable("Sessions", t =>
                        {
                            ...
                            t.HasCheckConstraint("Session_CeckEndDate", "EndDate > StartDate");
                        });
                });
            ...
            modelBuilder.Entity("GymManagementDAL.Entities.Trainer", b =>
                {
                    ...
                    b.ToTable("Trainers", t =>
                        {
                            t.HasCheckConstraint("Gym_CheckEmail", "Email LIKE '_%@_%._%'")
                                .HasName("Gym_CheckEmail1");

                            t.HasCheckConstraint("Gym_CheckPhone", "Phone LIKE '01%' and Phone Not Like '%[^0-9]%'")
                                .HasName("Gym_CheckPhone1");
                        });
                });
