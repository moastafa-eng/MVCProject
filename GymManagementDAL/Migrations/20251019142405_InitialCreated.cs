        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("Gym_CheckEmail", "Email LIKE '_%@_%._%'");
                    table.CheckConstraint("Gym_CheckPhone", "Phone LIKE '01%' and Phone Not Like '%[^0-9]%'");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("Plan_CheckDuration", "DurationDays Between 1 and 365");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("Gym_CheckEmail1", "Email LIKE '_%@_%._%'");
                    table.CheckConstraint("Gym_CheckPhone1", "Phone LIKE '01%' and Phone Not Like '%[^0-9]%'");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("Session_CeckEndDate", "EndDate > StartDate");
                    table.ForeignKey(
